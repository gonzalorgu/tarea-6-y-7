  ...
  <div class="page-container">
    ...
    <div class="header">
      ...
      <div class="header-actions">
        <button class="btn-nuevo" @click="abrirModal()" title="Agregar nueva llegada">
          Nueva Llegada
        </button>
        <button class="volver-btn" @click="volverDashboard" title="Volver al Dashboard">
          Volver al Dashboard
        </button>
      </div>
    </div>
      ...
      <table>
        ...
        <tbody>
          <tr v-for="item in llegadasFiltradas" :key="item.id_llegada">
            ...
            <td class="acciones">
              <button class="btn-editar" @click="abrirModal(item)" title="Editar llegada">
                Editar
              </button>
              <button class="btn-eliminar" @click="eliminar(item.id_llegada)" title="Eliminar llegada">
                Eliminar
              </button>
            </td>
          </tr>
